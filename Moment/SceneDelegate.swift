...
private extension SceneDelegate {
    ...
    func initUI() {
        guard let homeViewController = assembler?.resolver.resolve(HomeViewController.self) as? UIViewController else {
            rootViewController = HomeViewControllerImplemented.instantiate()
            return
        }
